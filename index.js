...
var finalAverage = Math.ceil((totalAverage/86)*100)/100
console.log(finalAverage)
var monthlyChange = []
for (var i = 0; i < finances.length-1; i ++){
    var month = finances[i][1]
    var nextmonth = finances[i + 1][1]
    monthlyChange.push(month - nextmonth)
}
var greatestIncrease = Math.max(...monthlyChange)
var greatestMonth = monthlyChange.indexOf(greatestIncrease)
console.log(finances[greatestMonth] )
